...
function ff_custom_setting(){
  //  register_setting('ff_theme_options', 'phone_field');
   ...
   // add_settings_field('theme-phone','Phone Number','theme_phone_func', 'theme_options','ff_theme_options');
    add_settings_field('logo','Website Logo (.jpg and .png allowed)','logo_display', 'theme_options','ff_theme_options');
}
...
include_once(ABSPATH . 'wp-admin/includes/file.php');
  if(!empty($_FILES["logo"]["tmp_name"]))
  {
    ...
    $urls = wp_handle_upload($_FILES["logo"], array('test_form' => FALSE), $overrides);
    $temp = $urls["url"];
    return $temp;  
  }
...
function bootstrap_scripts_enqueue() {
	...
	// wp_enqueue_style('thme-css',get_template_directory_uri().'/css/owl.theme.default.min.css');
	// wp_enqueue_style('owl-css',get_template_directory_uri().'/css/owl.carousel.min.css');
	
	    // all scripts
	//wp_enqueue_script( 'jquery-3-js', get_template_directory_uri() . '/js/jquery-1.12.4.min.js');
	// wp_enqueue_script( 'jq-js', get_template_directory_uri() . '/js/jquery.min.js');
	...
	// wp_enqueue_script( 'script-js', get_template_directory_uri() . '/js/script-all.js');
}
